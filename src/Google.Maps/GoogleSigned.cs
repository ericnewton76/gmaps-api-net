...
namespace Google.Maps
{
    ...
    public class GoogleSigned
    {
        ...
        private GoogleSignedType _signType = GoogleSignedType.None;
    ...
    {
        /// <summary>
        /// Indicates that no specific signing method will be used and logging will be based on the client IP address.
        /// </summary>
        None,
